%QPLOT Plot Baxter robot end-effector rpy angles
%
...
function baxter_rpyerrplot(t, q)
    if nargin < 2
        q = t;
        t = (1:numrows(q))';
    end
...
%     %hTitle = title('');
    ...
    hYLabel = ylabel('End-effector RPY Angle Error (degree)');
%     
