...
%     %hTitle = title('');
    ...
    hYLabel = ylabel('Joint Angles, q (rad)');
%     
    
    % Add legend
    hLegend = legend([hData1, hData2, hData3, hData4, hData5, hData6, hData7], ...
        '\Delta q1', '\Delta q2', '\Delta q3', '\Delta q4', '\Delta q5', '\Delta q6', '\Delta q7');
%     
%     % Adjust font
...
% Adjust axes properties
    ...
    %print -depsc2 lqgtracknoise.eps
%      close;