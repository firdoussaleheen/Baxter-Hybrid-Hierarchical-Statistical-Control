...
function baxter_xyzplot_left(t, q)
    if nargin < 2
        q = t;
        t = (1:numrows(q))';
    end
...
% square plot
figure('Position',[638 312 692 565]);hold on;
...
%     %hTitle = title('');
    ...
    hYLabel = ylabel('Agent1 (left arm) End-effector Position (mm)');
%     
    
    % Add legend
    hLegend = legend([hData1, hData2, hData3], ...
        'x', 'y', 'z');
%     
%     % Adjust font
